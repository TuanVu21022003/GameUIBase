...
{
    public class ModalFailByCage : Modal
    {
        [field: SerializeField] public ModalFailByCageContext.UIPresenter UIPresenter { get; private set; }
    ...
    [Serializable]
    public class ModalFailByCageContext
    {
